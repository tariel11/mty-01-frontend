      ...
      <div className="container">
        <div className={s.authbox}>
          ...
          { isRegistration && <> 
            ...
            <input type="email" placeholder='EMAIL ADRESS' required value={gmail} onChange={e => setGmail(e.target.value)} />
            ...
            <div className={s.privacybox}>
              ...
              <p onClick={()=> setPrivacy(!privacy)}>{privacy ? 'Скрыть' : 'Читать политику конфидицеальности'}</p>
